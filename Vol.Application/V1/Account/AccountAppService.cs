...
namespace Vol.V1.Account
{
    public class AccountAppService : ApplicationService, IAccountAppService
    {
        ...
        public virtual async Task SendPasswordResetCodeAsync(SendPasswordResetCodeDto input)
        {
            ...
            if (user.IsExternal)
            {
                throw new BusinessException(VolDomainErrorCodes.AccountExternalUserPasswordChange);
            }
        ...
        protected virtual async Task<User> GetUserByEmail(string email)
        {
            ...
            if (user == null)
            {
                throw new BusinessException(VolDomainErrorCodes.AccountInvalidEmailAddress);
            }
        ...
        private static void CheckLoginResult(Microsoft.AspNetCore.Identity.SignInResult result)
        {
            ...
            {
                throw new BusinessException(VolDomainErrorCodes.AccountLockedOut);
            }

            if (result.RequiresTwoFactor)
            {
                throw new BusinessException(VolDomainErrorCodes.AccountRequiresTwoFactor);
            }
        ...
        public async Task<UserProfileDto> GoogleLogin(GoogleCredentials credentials)
        {
            ...
            else
            {
                ...
                throw new BusinessException(VolDomainErrorCodes.AccountFacebookNoEmail);
            }
        }*/
        ...
        public async Task ConfirmEmailAsync(ConfirmEmailDto input)
        {
            ...
            if (user == null)
            {
                throw new BusinessException(VolDomainErrorCodes.UserNotFound);
            }
